            ...
            <ul className="flex flex-col items-center font-medium gap-3 sm:flex-row">
              {userRole === 1 && isAuthenticated === true ? (
                <li>
                  <Link
                    to="/registration"
                    className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 lg:hover:bg-transparent lg:border-0 hover:text-blue-500 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  >
                    <Button variant="outline" className="w-48 hover:text-blue-500">
